...
const CALLBACK_URL = "./view/callback";
const LOGOUT_URL = "./view/logout";
const ROP_LOGIN_PAGE_URL = "./view/login";
const ROP_SUBMIT = "./view/submit";
const PROTECTED_ENDPOINT = "/protected";
const CHANGE_PASSWORD_PAGE = './view/change/password';
const CHANGE_DETAILS_PAGE = './view/change/details';
const SIGN_UP_PAGE = "./view/sign_up";
const FORGOT_PASSWORD_PAGE = "./forgot_password";
const ACCOUNT_CONFIRMED_PAGE = "./account_confirmed";
const RESET_PASSWORD_PAGE = "./view/reset_password_form";
...
passport.use(new WebAppStrategy({
	tenantId: tenantId,
	clientId: "af1c8b5c-f6ca-4e90-a6d1-51d09f302afd",
	secret: "ZTNiYTIzODgtNzAwYi00MzFiLWI5YzgtYzAyZjJmNTcyYzEw",
	oauthServerUrl: "https://appid-oauth.ng.bluemix.net/oauth/v3/30f1814a-6a50-48f8-a7d8-eda96b76506b",
	redirectUri: "http://localhost:1234" + CALLBACK_URL
}));

let selfServiceManager = new SelfServiceManager({
	iamApiKey: "BfRd7eNZLRSktHvQqIc1ObCqHs72I7m19p4Y3UuCZ5Nz",
	managementUrl: "https://appid-management.ng.bluemix.net/management/v4/30f1814a-6a50-48f8-a7d8-eda96b76506b"
});
...
app.listen(port, function() {
	logger.info("Listening on http://localhost:" + port + "/index.html");
});