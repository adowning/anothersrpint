...
//     location = 'Vermont',
//   } = params;
//   console.log(params.__ow_body[0])
  var locationUpdate = params.__ow_body[0]
...
body.rows.forEach((doc) => {
    ...
    if(doc.doc.deviceId == locationUpdate.deviceId){
        array.push(doc.doc)
    }
  });
  return array  
})
if(onlinelist.length < 1 || !onlinelist){
    params.userList = new Array()
}else{
